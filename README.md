...
|----------|--------------------------------------------------------------------------|----------------------------------------------------------------|---------------|---------------|
| <a href="addon/perses-demo/README.md">Perses</a>  | Ejemplo aislado de perses           | Python, Prometheus, Perses.                    | ✅ OK  | KCD México 2026. |
| <a href="addon/observabilidad-minio-loki-tempo/README.md">minIO</a>  | Ejemplo aislado de minIO         | Java, Fluent bit,OpenTelemetry Collector, Prometheus, minIO.                     | ✅ OK  | KCD México 2026. |
