...
Crearemos una aplicación java, utilizando Springboot; crearemos:
* Un controlador: HelloController
* Una aplicación: AppJavaApplication
* Una clase para meter test: AppJavaApplicationTests
